  ...
  return (
    ...
    <div className='postContanair'>
        <div className="postTop">
            <img src=" https://images.pexels.com/photos/733872/pexels-photo-733872.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error" className="postImage" />
            <span className="postUserName"> Marshi Fenando</span>
            <span className="postTime">1 hour ago <b>.</b></span>
        ...
        <div className="postCenter">
            <div className="postCaption">
                 The biggest Aminal in Africa 🐘 


            </div>
            <img src=" https://t3.ftcdn.net/jpg/07/34/02/40/240_F_734024005_KcLhJo0QpNPBsW47LevapbxAzXHo2bEz.jpg" alt="error" className="postedImage" />
        </div>
        <div className="postBottom"> 
            <div className="postBottomLeft">
                ...
                <span className="likeCount">Mendis and 201 others</span>
            </div>
            <div className="postBottomRight">
                <span className="commentCount">67 Comments</span>
            </div>
