  ...
  return (
    ...
    <div className='postContanair'>
        <div className="postTop">
            <img src=" https://images.pexels.com/photos/712513/pexels-photo-712513.jpeg?auto=compress&cs=tinysrgb&w=600" alt="error" className="postImage" />
            <span className="postUserName">Shehani Perera</span>
            <span className="postTime">2 Days ago <b>.</b></span>
        ...
        <div className="postCenter">
            ...
            <img src=" https://static.vecteezy.com/system/resources/previews/035/583/695/non_2x/ai-generated-cute-little-girl-with-blue-eyes-in-a-white-shawl-adorable-little-baby-portrait-cute-baby-girl-indoor-ai-generated-free-photo.jpg" alt="error" className="postedImage" />
        </div>
        <div className="postBottom"> 
            <div className="postBottomLeft">
                ...
                <span className="likeCount">Micky Marting and 382 others</span>
            </div>
